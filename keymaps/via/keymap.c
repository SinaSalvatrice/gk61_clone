...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_custom(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_RALT, FN, KC_RCTL, KC_LEFT, KC_NO, KC_NO
    ),
    ...
    [_FN] = LAYOUT_60_custom(
        ...
        _______, RM_HUEU, RM_SATU, RM_VALU, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO,
        _______, RM_HUED, RM_SATD, RM_VALD, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO, KC_NO,
        _______, _______, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, _______, RM_TOGG, RM_NEXT, RM_PREV, KC_NO, KC_NO
    ),
    ...
    [_RGB] = LAYOUT_60_custom(
        ...
        _______, RM_HUED, RM_SATD, RM_VALD,  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO, KC_NO,
        _______, _______, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______, _______, _______, KC_NO, KC_NO
    )
};
